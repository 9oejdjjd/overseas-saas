    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                // Removed hidden classes for dropdown containers
                dropdown_month: "flex [&>.ant-select-trigger]:h-7", // adjust based on select usage
                dropdown_year: "flex [&>.ant-select-trigger]:h-7",
