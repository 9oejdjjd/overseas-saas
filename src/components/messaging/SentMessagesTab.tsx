    ...
    if (sentMessages.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center animate-fade-in">
                ...
                <h3 className="font-bold text-slate-700 dark:text-slate-200 text-lg">لا توجد رسائل مُرسلة</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm mt-1 max-w-xs">سجل المراسلات فارغ حالياً.</p>
            </div>
        );
    }
                ...
                return (
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <div className="h-11 w-11 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold text-base shrink-0">
                                {initials}
                            </div>
                            <div className="space-y-0.5">
                                ...
                                <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 flex-wrap">
                                    ...
                                    <span className="font-mono text-[11px]">
                                        {new Date(msg.sentAt).toLocaleDateString('ar-EG', {
                                            year: 'numeric',
                                            month: '2-digit',
                                            day: '2-digit'
                                        })}
                        ...
                        <div className="flex items-center justify-end gap-3 self-end sm:self-center">
                            ...
                            <Badge variant="outline" className="text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900/50 bg-emerald-50/50 dark:bg-emerald-950/20 text-xs py-0.5 px-2.5 rounded-full font-bold">
                                <CheckCircle2 className="h-3.5 w-3.5 ml-1 shrink-0" />
                                تم الإرسال
                            </Badge>
                        </div>
                    </div>
