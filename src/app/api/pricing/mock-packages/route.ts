    ...
    try {
        ...
        const newPackage = await prisma.mockExamPackage.create({
            data: {
                ...
                agentPrice: Number(body.agentPrice || 0),
                ...
                examQuestionsCount: body.examQuestionsCount !== undefined && body.examQuestionsCount !== null ? Number(body.examQuestionsCount) : null,
