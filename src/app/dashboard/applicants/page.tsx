...
export default function ApplicantsPage() {
  ...
  useEffect(() => {
    ...
    document.addEventListener('refresh-applicants-table', handleRefresh);

    return () => {
      document.removeEventListener('open-applicant-modal', handleDetailEvent);
      document.removeEventListener('refresh-applicants-table', handleRefresh);
    };
  }, []);
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                toast('فشل الاتصال. حاول مرة أخرى', 'error');
              } finally {
